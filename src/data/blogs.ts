...
export const blogsData: BlogPost[] = [
  {
    ...
    content: `
      ...
      <img src="/indi-blog/agentic_qa.png" alt="Agentic QA overview" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
      ...
      <img src="/indi-blog/how_intelegent_testing_work.png" alt="How intelligent testing works" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
  ...
  },
  {
    ...
    content: `
      ...
      <img src="/indi-blog/global_fintech_cuts_qa_time_by_80_1.png" alt="Global FinTech Challenge" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
      ...
      <img src="/indi-blog/global_fintech_cuts_qa_time_by_80_2.png" alt="Transforming Quality Engineering" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
  ...
  },
  {
    ...
    content: `
      ...
      <img src="/indi-blog/scaling_test_infrastructure_in_2026_1.png" alt="Scaling Test Infrastructure" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
  ...
  },
  {
    ...
    content: `
      ...
      <img src="/indi-blog/self_healing_automation_handbook.png" alt="Self-Healing Automation Handbook" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
  ...
  },
  {
    ...
    image: "/blogs/insurance_enterprise_accelerates_delivery.png",
    readTime: "7 min read",
    date: "March 10, 2026",
    author: "Presales Team",
    ...
    content: `
      ...
      <img src="/indi-blog/insurance_enterprise_accelerates_delivery.png" alt="Insurance Enterprise Accelerates Delivery" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
  ...
  },
  {
    ...
    image: "/blogs/future_of_automation_testing.png",
    readTime: "4 min read",
    ...
    content: `
      ...
      <img src="/indi-blog/future_of_automation_testing.png" alt="Future of Automation Testing" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
  ...
  },
  {
    ...
    image: "/blogs/from_manual_testing_to_autonomous_quality_engineering.png",
    ...
    content: `
      ...
      <img src="/indi-blog/from_manual_testing_to_autonomous_quality_engineering.png" alt="From Manual Testing to Autonomous Quality Engineering" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
  ...
  },
  {
    ...
    image: "/blogs/why_real_device_testing_matters_more_than_ever.png",
    readTime: "6 min read",
    ...
    content: `
      ...
      <img src="/indi-blog/why_real_device_testing_matters_more_than_ever.png" alt="Why Real Device Testing Matters More Than Ever" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
  ...
  },
  {
    ...
    image: "/blogs/ai_powered_test_automation_beyond_record_and_playback.png",
    readTime: "4 min read",
    ...
    content: `
      ...
      <img src="/indi-blog/ai_powered_test_automation_beyond_record_and_playback.png" alt="AI-Powered Test Automation" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
  ...
  },
  {
    ...
    image: "/blogs/continuous_testing_in_the_devops_era.png",
    readTime: "7 min read",
    ...
    content: `
      ...
      <img src="/indi-blog/continuous_testing_in_the_devops_era.png" alt="Continuous Testing in the DevOps Era" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
  ...
  },
  {
    ...
    image: "/blogs/the_rise_of_unified_test_management_platforms.png",
    readTime: "5 min read",
    ...
    content: `
      ...
      <img src="/indi-blog/the_rise_of_unified_test_management_platforms.png" alt="The Rise of Unified Test Management Platforms" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
  ...
  },
  {
    ...
    content: `
      ...
      <img src="/indi-blog/the_roi_of_test_automation_measuring_what_matters.png" alt="The ROI of Test Automation" className="w-full rounded-lg my-8 shadow-sm border border-app-border" />
