...
export default function DeviceLabHero() {
    ...
    <section ref={containerRef} className="relative w-full h-screen min-h-[800px] flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-8 flex flex-col items-start justify-center">
        ...
        >
          ...
          <span className="text-white/80 text-xs font-bold tracking-[0.2em] uppercase">Enterprise Device Infrastructure</span>
        </motion.div> */}
        ...
        >
          Validate applications on actual iOS and Android devices, ensuring accurate simulation of real-world user experiences across any hardware configuration, screen size, or network condition.
        </motion.p>
        ...
        >
          <button className="px-10 py-4 bg-[#6843B7] text-white text-[15px] font-bold rounded-md shadow-[0_0_40px_rgba(104,67,183,0.5)] hover:scale-105 active:scale-95 transition-all">
            Access Device Lab
          </button>
          <button className="px-10 py-4 bg-white/5 backdrop-blur-md border border-white/10 text-white text-[15px] font-bold rounded-md hover:bg-white/10 hover:border-white/30 transition-all active:scale-95">
            View Capabilities
          </button>
        </motion.div>
      </div>
