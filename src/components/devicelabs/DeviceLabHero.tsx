...
export default function DeviceLabHero() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[85vh] md:min-h-screen bg-black flex flex-col justify-center border-b border-white/5 overflow-hidden">
      ...
      >
        <Image
          src="/images/device-labs-hero.png"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-8 flex flex-col items-center md:items-start justify-center text-center md:text-left">
        {/* <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-sm bg-white/5 border border-white/10 backdrop-blur-md mb-8"
        >
        ...
        >
          <button onClick={() => window.scrollTo({ top: window.innerHeight, behavior: 'smooth' })} className="flex-1 sm:flex-none px-4 sm:px-10 py-3.5 sm:py-4 bg-[#6843B7] text-white text-[12px] sm:text-[15px] font medium rounded-sm ] hover:scale-105 active:scale-95 transition-all whitespace-nowrap">
            Explore Device Lab
          </button>
