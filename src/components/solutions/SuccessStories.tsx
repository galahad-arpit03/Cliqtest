...
import { ShieldCheck, Code2, LineChart, Building2 } from 'lucide-react';
...
const features = [
  {
    ...
    desc: "Axis Bank adopted ApMoSys’s innovative solutions as part of their digital transformation journey. The partnership enabled smooth deployment of tailored technology that aligned with their strategic goals, significantly boosting operational efficiency and streamlining key banking functions across their ecosystem.\n\nBank of Maharashtra deployed the Netraa Lighthouse Synthetic Monitoring platform, ensuring end-to-end uptime visibility, faster incident detection, and improved digital channel reliability. Similarly, UCO Bank, RBL Bank, ABCD Bank, and IDBI Bank implemented our cliQTest and Netraa solutions to enable real-time performance visibility, faster issue resolution, and improved system reliability.",
    benefits: [
      'Axis Bank: Boosted operational efficiency',
      'Bank of Maharashtra: End-to-end uptime visibility',
      'UCO Bank & RBL Bank: Faster issue resolution',
      'IDBI Bank: Improved system reliability'
    ],
    theme: "purple",
    icon: Building2
  },
  {
    ...
    desc: "CRIS leveraged ApMoSys’s cliQTest platform to streamline their testing processes. The platform’s robust automation capabilities and user-friendly interface significantly improved test accuracy and speed, empowering the team to deliver quality software with greater efficiency and confidence across projects.\n\nProtean implemented our Netraa Lighthouse Synthetic Monitoring solution for Protean eGov Technologies, enabling continuous availability checks, proactive performance alerts, and seamless digital experience assurance. NSDL Payments Bank leveraged our cliQTest solution for real-time visibility.",
    benefits: [
      'CRIS: Improved test accuracy and speed',
      'Protean: Continuous availability checks',
      'NSDL Payments Bank: Real-time visibility'
    ],
    theme: "teal",
    icon: ShieldCheck
  },
  ...
  },
  {
    ...
    desc: "Generali Central Life Insurance implemented its Netraa APM solution, enabling real-time performance visibility, faster issue resolution, and improved system reliability across their entire application ecosystem.\n\nIn the pharmaceutical sector, FDC India implemented its Netraa APM solution, enabling real-time performance visibility, faster issue resolution, and improved system reliability.",
    benefits: [
      'Generali Central Life Insurance: Real-time APM visibility',
      'FDC India: Faster issue resolution and reliability'
    ],
    theme: "teal",
    icon: Code2
  }
