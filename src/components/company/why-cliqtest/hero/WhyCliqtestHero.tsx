    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-8 pt-48 pb-20">
        ...
        <motion.div 
          ...
          className="max-w-4xl"
        >
          <span className="text-[#6843B7] text-[10px] md:text-sm font-semibold uppercase tracking-[0.3em] mb-4 block md:hidden">Platform Value</span>
          ...
          <p className="text-app-fg/60 text-sm md:text-base leading-relaxed max-w-3xl mb-10">
