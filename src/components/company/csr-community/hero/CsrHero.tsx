    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-8 pt-32 pb-20">
        ...
        <motion.div 
          ...
          className="max-w-4xl"
        >
          <span className="text-[#6843B7] text-[10px] md:text-sm font-semibold uppercase tracking-[0.3em] mb-4 block md:hidden">CSR & Community</span>
          
          <h1 className="text-app-fg text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 leading-[1.1]">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6843B7] to-[#ffffff]">CSR & Community</span>
          </h1>

          <p className="text-app-fg/90 text-base md:text-lg font-semibold leading-relaxed max-w-2xl mb-6">
            Community Initiatives and Innovation & Learning.
          </p>
