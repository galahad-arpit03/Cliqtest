...
export default function MissionVision() {
  return (
    <section className="bg-app-bg py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          {missionVisionData.map((item) => (
            <motion.div 
              ...
              className="bg-app-surface border border-app-border rounded-md p-8 md:p-10 relative overflow-hidden group shadow-2xl"
            >
              {item.id === "mission" && (
              ...
              <h2 className="text-2xl font-bold text-app-fg mb-4 tracking-tight">
              ...
              <p className="text-app-fg/60 text-[14px] leading-relaxed relative z-10">
                {item.description}
              </p>
            </motion.div>
          ))}
