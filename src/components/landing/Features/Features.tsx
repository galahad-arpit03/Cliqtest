...
export default function Features() {
  return (
    <section className="w-full px-12 py-20 text-center">
      <h2 className="text-4xl md:text-6xl font medium text-app-fg mb-6 tracking-tight">
      ...
      <div className="flex justify-center">
        <button className="px-10 py-3 bg-[#6843B7] text-app-fg text-xs font medium tracking-[0.2em] rounded-sm uppercase ] hover:scale-105 transition-transform">
