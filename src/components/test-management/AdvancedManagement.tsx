      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <motion.div
            ...
            className="lg:col-span-7 group rounded-md bg-white/[0.02] backdrop-blur-lg border border-white/10 shadow-2xl p-10 lg:p-14 hover:border-white/20 hover:bg-white/[0.05] transition-all relative overflow-hidden flex flex-col justify-between"
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl md:text-4xl font-black text-white mb-6 tracking-tight"><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6843B7] to-[#8f81eb]">Comprehensive</span> Test Plans</h3>
              <p className="text-white/60 text-[17px] leading-relaxed mb-10 max-w-lg">
            ...
            <div className="relative z-10 grid sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="flex flex-col gap-1 p-4 rounded-md bg-white/[0.02] border border-white/5 group-hover:bg-white/[0.04] transition-colors">
                  <span className="text-white/90 text-[14px] font-bold">{item.title}</span>
          ...
          <motion.div
            ...
            className="lg:col-span-5 group rounded-md bg-white/[0.02] backdrop-blur-lg border border-white/10 shadow-2xl p-10 lg:p-14 hover:border-white/20 hover:bg-white/[0.05] transition-all relative overflow-hidden flex flex-col justify-between"
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl md:text-4xl font-black text-white mb-6 tracking-tight">End-to-End <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6843B7] to-[#8f81eb]">Traceability</span></h3>
