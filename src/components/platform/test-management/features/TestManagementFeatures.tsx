              ...
              <div className={`lg:col-span-4 flex flex-col gap-4 order-2 ${idx % 2 === 0 ? 'lg:order-1' : 'lg:order-2'}`}>
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col gap-3 p-6 opacity-[0.08] pointer-events-none overflow-hidden justify-center">
                    <div className="h-2 w-full bg-app-fg rounded-md" />
                    <div className="h-2 w-3/4 bg-app-fg rounded-md" />
                    <div className="h-2 w-5/6 bg-app-fg rounded-md" />
                    <div className="h-2 w-1/2 bg-app-fg rounded-md" />
                    <div className="h-2 w-full bg-app-fg rounded-md" />
                    <div className="h-2 w-2/3 bg-app-fg rounded-md" />
                  </div>
