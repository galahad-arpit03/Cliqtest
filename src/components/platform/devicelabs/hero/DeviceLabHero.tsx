    ...
    <section ref={containerRef} className="relative min-h-[85vh] md:min-h-screen bg-app-bg flex flex-col justify-center border-b border-app-border overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-8 flex flex-col items-center md:items-start justify-center text-center md:text-left">
        {/* <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-sm bg-app-fg/5 border border-app-border backdrop-blur-md mb-8"
        >
          <span className="w-2 h-2 rounded-full bg-[#00F2B0] animate-pulse" />
          <span className="text-app-fg/80 text-xs font medium tracking-[0.2em] uppercase">Enterprise Device Infrastructure</span>
        </motion.div> */}
