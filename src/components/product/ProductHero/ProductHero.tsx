...
export default function ProductHero() {
  ...
  return (
    <section className="relative pt-24 pb-16 px-12 lg:px-24 bg-app-bg min-h-[80vh] flex flex-col justify-between overflow-hidden">
      {/* Background Glows */}
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-20 items-center flex-1">
        ...
        <div className="text-left">
          <h4 className="text-app-muted text-[13px] font-black tracking-[0.3em] uppercase mb-10">
            GO BEYOND SIMPLE TASK AUTOMATION WITH THE
          </h4>
          <h1 className="text-app-fg text-5xl md:text-[72px] font medium leading-[1] tracking-tight mb-8">
            Functionize <br />
            Agentic Digital <br />
            Worker Platform
          </h1>
        ...
        <div className="relative aspect-square w-full max-w-[600px] mx-auto lg:mx-0">
          ...
          <div className="absolute inset-0 bg-zinc-900/40 border border-app-border rounded-[40px] backdrop-blur-3xl flex items-center justify-center overflow-hidden">
      ...
      <div className="w-full flex justify-center pb-8 mt-12 lg:mt-0">
        <div className="flex items-center p-1.5 bg-app-fg/5 backdrop-blur-xl rounded-sm border border-app-border shadow-2xl">
          {tabs.map((tab) => (
            <button
              key={tab}
