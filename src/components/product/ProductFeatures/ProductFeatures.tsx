    ...
    <section className="bg-black py-32 px-12">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-24">
          <h2 className="text-white text-4xl md:text-6xl font medium mb-8 leading-tight max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gradient-to-br from-zinc-900 to-black border border-white/10 rounded-[32px] p-10 flex flex-col min-h-[600px] justify-between group hover:border-[#00F2B0]/30 transition-all">
            <div>
              <h3 className="text-white text-4xl font medium mb-8">Supercharge <br /> productivity</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-zinc-900/40 border border-white/10 rounded-[24px] p-8 hover:bg-zinc-900/60 transition-all group">
              ...
              <h3 className="text-white text-2xl font medium mb-4">Optimize expenses</h3>
            ...
            <div className="bg-zinc-900/40 border border-white/10 rounded-[24px] p-8 hover:bg-zinc-900/60 transition-all group">
              ...
              <h3 className="text-white text-2xl font medium mb-4">Outpace your rivals</h3>
              <p className="text-zinc-400 leading-relaxed">
            ...
            <div className="bg-zinc-900/40 border border-white/10 rounded-[24px] p-8 hover:bg-zinc-900/60 transition-all group">
              ...
              <h3 className="text-white text-2xl font medium mb-4">Drive top-line growth</h3>
              <p className="text-zinc-400 leading-relaxed">
            ...
            <div className="bg-zinc-900/40 border border-white/10 rounded-[24px] p-8 hover:bg-zinc-900/60 transition-all group">
              ...
              <h3 className="text-white text-2xl font medium mb-4">Unlock cloud-scale growth</h3>
              <p className="text-zinc-400 leading-relaxed">
