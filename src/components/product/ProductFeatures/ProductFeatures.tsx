    ...
    <section className="bg-app-bg py-32 px-12">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-24">
          <h2 className="text-app-fg text-4xl md:text-6xl font medium mb-8 leading-tight max-w-4xl mx-auto">
            Exponentially Boost Operational Efficiency with <span className="text-[#6843B7]">Agentic Digital Workers</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gradient-to-br from-zinc-900 to-app-bg border border-app-border rounded-[32px] p-10 flex flex-col min-h-[600px] justify-between group hover:border-[#00F2B0]/30 transition-all">
            <div>
              <h3 className="text-app-fg text-4xl font medium mb-8">Supercharge <br /> productivity</h3>
              <p className="text-app-muted leading-relaxed text-xl max-w-md">
            ...
            <div className="mt-12 w-full aspect-square bg-[#00F2B0]/5 rounded-md relative overflow-hidden flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-zinc-900/40 border border-app-border rounded-[24px] p-8 hover:bg-zinc-900/60 transition-all group">
              <div className="w-12 h-12 rounded-md bg-[#00F2B0]/10 flex items-center justify-center mb-6 group-hover:bg-[#00F2B0]/20 transition-colors">
                <Zap className="text-[#00F2B0]" size={24} />
              </div>
              <h3 className="text-app-fg text-2xl font medium mb-4">Optimize expenses</h3>
            ...
            <div className="bg-zinc-900/40 border border-app-border rounded-[24px] p-8 hover:bg-zinc-900/60 transition-all group">
              <div className="w-12 h-12 rounded-md bg-blue-500/10 flex items-center justify-center mb-6 group-hover:bg-blue-500/20 transition-colors">
                <TrendingUp className="text-[#6843B7]" size={24} />
              </div>
              <h3 className="text-app-fg text-2xl font medium mb-4">Outpace your rivals</h3>
              <p className="text-app-muted leading-relaxed">
            ...
            <div className="bg-zinc-900/40 border border-app-border rounded-[24px] p-8 hover:bg-zinc-900/60 transition-all group">
              <div className="w-12 h-12 rounded-md bg-purple-500/10 flex items-center justify-center mb-6 group-hover:bg-purple-500/20 transition-colors">
                <Network className="text-purple-400" size={24} />
              </div>
              <h3 className="text-app-fg text-2xl font medium mb-4">Drive top-line growth</h3>
              <p className="text-app-muted leading-relaxed">
            ...
            <div className="bg-zinc-900/40 border border-app-border rounded-[24px] p-8 hover:bg-zinc-900/60 transition-all group">
              <div className="w-12 h-12 rounded-md bg-cyan-500/10 flex items-center justify-center mb-6 group-hover:bg-cyan-500/20 transition-colors">
                <Cloud className="text-cyan-400" size={24} />
              </div>
              <h3 className="text-app-fg text-2xl font medium mb-4">Unlock cloud-scale growth</h3>
              <p className="text-app-muted leading-relaxed">
