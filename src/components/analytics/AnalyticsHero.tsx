  ...
  return (
    <section ref={containerRef} className="relative min-h-[85vh] md:min-h-screen bg-black flex flex-col justify-center border-b border-white/5 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-8 flex flex-col items-center md:items-start justify-center text-center md:text-left">
        <span className="text-[#6843B7] text-[10px] md:text-sm font-semibold uppercase tracking-[0.3em] mb-4 block md:hidden">Analytics & Reporting.</span>
          <motion.h1
        ...
        >
          Transform complex testing data into actionable business insights. Monitor KPIs, track execution progress, and identify bottlenecks in real time with centralized, enterprise-grade dashboards.
        </motion.p>
