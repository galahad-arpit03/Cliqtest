      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12 text-white/70 leading-relaxed text-[15px] md:text-[16px]">
          <section className="space-y-4">
            ...
            <p>
              This Cookie Policy explains how <strong className="text-white font-medium">CliQTest®</strong> uses cookies and similar technologies to improve functionality, enhance security, optimize user experience, and analyze platform performance.
            </p>
          </section>

          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">What Are Cookies</h2>
            <p>
          ...
          <section className="space-y-6">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Categories of Cookies</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#0A0A0A] border border-white/10 rounded-md p-6">
                <h3 className="text-white text-lg font-semibold mb-4 text-[#6843B7]">Essential Cookies</h3>
              ...
              <div className="bg-[#0A0A0A] border border-white/10 rounded-md p-6">
                <h3 className="text-white text-lg font-semibold mb-4 text-[#6843B7]">Functional Cookies</h3>
              ...
              <div className="bg-[#0A0A0A] border border-white/10 rounded-md p-6">
                <h3 className="text-white text-lg font-semibold mb-4 text-[#6843B7]">Analytics Cookies</h3>
                <p className="mb-3 text-sm">Used for:</p>
                <ul className="list-disc pl-5 space-y-1 text-white/80 text-sm">
              ...
              <div className="bg-[#0A0A0A] border border-white/10 rounded-md p-6">
                <h3 className="text-white text-lg font-semibold mb-4 text-[#6843B7]">Security Cookies</h3>
                <p className="mb-3 text-sm">Used for:</p>
                <ul className="list-disc pl-5 space-y-1 text-white/80 text-sm">
          ...
          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Third-Party Technologies</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Cookie Management</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Updates</h2>
            <p>
