      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12 text-white/70 leading-relaxed text-[15px] md:text-[16px]">
          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Acceptance of Terms</h2>
            <p>
              By accessing or using <strong className="text-white font-medium">CliQTest®</strong>, users agree to comply with and be bound by these Terms & Conditions.
            </p>
          </section>

          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Ownership and Intellectual Property</h2>
            <p>CliQTest®, including but not limited to:</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 pl-6">
              <ul className="list-disc space-y-2 text-white/80">
                <li>Software</li>
                <li>Source code</li>
                <li>Object code</li>
                <li>AI models</li>
          ...
          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">License Grant</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Restrictions</h2>
            <p>Users shall not:</p>
          ...
          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Protection of Proprietary Assets</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Customer Content</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Artificial Intelligence Features</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Service Availability</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Limitation of Liability</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Indemnification</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-white text-2xl font-bold tracking-tight mb-6">Governing Law</h2>
            <p>
